...
List<BottomNavigationBarItem> navBarList = [
  BottomNavigationBarItem(
    ...
    activeIcon: GlowIcon(
      ...
      child: Image.asset(AppAssets.monitorIcon, height: 24.h, width: 24.w, color: AppColors.purple661F),
    ),
    label: '',
  ),
  BottomNavigationBarItem(
  ...
  BottomNavigationBarItem(
    ...
    activeIcon: GlowIcon(
      glowColor: AppColors.purple661F,
      child: Image.asset(AppAssets.insightIcon, height: 24.h, width: 24.w, color: AppColors.purple661F),
    ),
    label: '',
  ),
  BottomNavigationBarItem(
    ...
    activeIcon: GlowIcon(
      glowColor: AppColors.purple661F,
      child: Image.asset(AppAssets.profileIcon, height: 24.h, width: 24.w, color: AppColors.purple661F),
    ),
    label: '',
  ),
];
