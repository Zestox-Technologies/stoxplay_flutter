...
class _SplashPageState extends State<SplashPage>
  ...
  void _setupAnimations() {
    ...
    _textMoveAnimation = Tween<double>(begin: 0, end: 100).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _iconShadowOpacityAnimation = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _buttonShowOpacityAnimation = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(
        parent: _controller,
